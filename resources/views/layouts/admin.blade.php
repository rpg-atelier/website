...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/admin') }}" class="brand-link">
            <span class="brand-text font-weight-light">RPG-Atelier</span>
        </a>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2000-{{ \Carbon\Carbon::now()->year }} <a href="https://rpg-atelier.net">rpg-atelier Team</a>.</strong>
        All rights reserved.
        <div class="float-right d-none d-sm-inline-block">
            <b>Version</b> 0.0.1 prä-Alpha
        </div>
    </footer>
</div>
<!-- ./wrapper -->
